...
export const TASK_SEQUENCE: SequenceEntry[] = [
  ...
  { seq: 26.5, assignee: 'FF', milestone: 'Destination', persona: 'FF',
    taskByMode: { FCL: 'FF Charge Confirmation', LCL: 'FF Charge Confirmation', AIR: 'FF Charge Confirmation', BB: 'FF Charge Confirmation', BULK: 'FF Charge Confirmation' } },
  { seq: 26.6, assignee: 'FF', milestone: 'Destination', persona: 'FF',
    taskByMode: { FCL: 'FF Invoice Generation', LCL: 'FF Invoice Generation', AIR: 'FF Invoice Generation', BB: 'FF Invoice Generation', BULK: 'FF Invoice Generation' } },
  ...
  { seq: 27.5, assignee: 'CHA', milestone: 'Destination', persona: 'CHA',
    taskByMode: { FCL: 'CHA Charge Confirmation', LCL: 'CHA Charge Confirmation', AIR: 'CHA Charge Confirmation', BB: 'CHA Charge Confirmation', BULK: 'CHA Charge Confirmation' } },
  { seq: 27.6, assignee: 'CHA', milestone: 'Destination', persona: 'CHA',
    taskByMode: { FCL: 'CHA Invoice Generation', LCL: 'CHA Invoice Generation', AIR: 'CHA Invoice Generation', BB: 'CHA Invoice Generation', BULK: 'CHA Invoice Generation' } },
