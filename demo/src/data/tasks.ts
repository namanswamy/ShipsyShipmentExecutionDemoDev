...
export const shipments: ShipmentData[] = [
  ...
  {
    id: "SEHR38415",
    masterReferenceNumber: "SEHR38415",
    mode: "BULK",
    type: "Import",
    incoterm: "CFR",
    originPortCode: "BRSSZ",
    originPortName: "Santos",
    destinationPortCode: "INMUN",
    destinationPortName: "Mundra",
    milestone: "DRAFT",
    milestoneLabel: "Drafts",
    supplierName: "BrazilAgro SA",
    ffName: "",
    cargoType: "BULK",
    cargoSubtype: "Soybean Meal",
    containerList: [],
    tasksDone: 0,
    tasksTotal: 19,
    tasksDueTodayCount: 0,
  ...
  {
    id: "DEMO-READY",
    masterReferenceNumber: "DEMO-READY",
    mode: "FCL",
    type: "Import",
    incoterm: "FOB",
    originPortCode: "CNSHA",
